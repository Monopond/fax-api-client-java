...
public class DocumentContentTypeNotFoundExceptionException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1392711448896L;
    
    private com.monopond.api.fax.soap.v2_1.ApiServiceStub.DocumentContentTypeNotFoundException faultMessage;
    ...
    public void setFaultMessage(com.monopond.api.fax.soap.v2_1.ApiServiceStub.DocumentContentTypeNotFoundException msg){
       faultMessage = msg;
    }
    
    public com.monopond.api.fax.soap.v2_1.ApiServiceStub.DocumentContentTypeNotFoundException getFaultMessage(){
       return faultMessage;
    }
}
