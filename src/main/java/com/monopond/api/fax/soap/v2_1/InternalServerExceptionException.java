...
public class InternalServerExceptionException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1392711448870L;
    
    private com.monopond.api.fax.soap.v2_1.ApiServiceStub.InternalServerException faultMessage;
    ...
    public void setFaultMessage(com.monopond.api.fax.soap.v2_1.ApiServiceStub.InternalServerException msg){
       faultMessage = msg;
    }
    
    public com.monopond.api.fax.soap.v2_1.ApiServiceStub.InternalServerException getFaultMessage(){
       return faultMessage;
    }
}
