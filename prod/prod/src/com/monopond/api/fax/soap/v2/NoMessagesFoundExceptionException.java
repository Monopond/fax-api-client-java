...
public class NoMessagesFoundExceptionException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1375778949864L;
    
    private com.monopond.api.fax.soap.v2.ApiServiceStub.NoMessagesFoundException faultMessage;
    ...
    public void setFaultMessage(com.monopond.api.fax.soap.v2.ApiServiceStub.NoMessagesFoundException msg){
       faultMessage = msg;
    }
    
    public com.monopond.api.fax.soap.v2.ApiServiceStub.NoMessagesFoundException getFaultMessage(){
       return faultMessage;
    }
}
